const bodyClass = "bg-purple-600 bg-gradient-to-br from blue-300 bf-opacity-25"
const bdy = document.querySelector("body")
//this split method create an array 
bodyClass.split(" ").forEach((cls) => bdy.classList.add(cls));

const calcBodyClass = "max-w-lg rounded overflow-hidden shodow-2xl bg-pink-700 bg-opacity-75 bg-gradient-to-tr from-gray-800 flex"
...
function addClasses(button){
    ...
    const btnOpClass = "hover:bg-blur-500 border-blue-500"
    ...
    const baseClass = 
    "flex w12 h-12 justify-center items-center m-1 font-bold py-2 px-2 border hover:border-transparent rounded text-white border-2 text-2xl"
